Fork if you already have mnemonics(Argentx) and want to generate from it addresses, private keys and public keys. Put your seeds to data/my_argent_seeds.txt
